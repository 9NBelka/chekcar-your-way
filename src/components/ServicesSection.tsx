...
const services = [
  ...
  },
  {
    ...
    description: "Діагностика + заправка фреоном R134a/R1234yf",
    price: "від 1500 грн"
  },
  {
    icon: Target,
    title: "Розвал-сходження",
    description: "3D стенд з точністю до 0.01° для всіх типів авто",
    price: "від 800 грн"
  },
  {
    icon: Car,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-text-light max-w-3xl mx-auto">
            Професійне обслуговування автомобілів будь-якої марки з використанням сучасного обладнання та оригінальних запчастин
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <p className="text-text-light mb-6">
            Не знайшли потрібну послугу? Зв'яжіться з нами – ми обслуговуємо автомобілі будь-якої складності!
          </p>
          <button 
