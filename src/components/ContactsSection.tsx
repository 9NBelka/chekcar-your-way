                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      <p className="text-text-light">
                        <a href="tel:+380441234567" className="hover:text-brand-blue transition-colors">
                          +38 (044) 123-45-67
                        </a>
                      </p>
                      <p className="text-text-light">
                        <a href="tel:+380671234567" className="hover:text-brand-blue transition-colors">
                          +38 (067) 123-45-67
                        </a>
                      </p>
                    </div>
